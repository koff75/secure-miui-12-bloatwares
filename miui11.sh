...
adb shell pm uninstall -k --user 0 com.android.calendar #Calendar
adb shell pm uninstall -k --user 0 com.android.chrome #Google Chrome
adb shell pm uninstall -k --user 0 com.android.mms #Messages
adb shell pm uninstall -k --user 0 com.mipay.wallet.in #Mi Wallet India
...
adb shell pm uninstall -k --user 0 com.mi.android.globalFileexplorer #Administrador
...
adb shell pm uninstall -k --user 0 com.miui.calculator #Calculator
...
adb shell pm uninstall -k --user 0 com.miui.msa.global #Main System Advertising
...
adb shell pm uninstall -k --user 0 com.miui.providers.weather # Mi Weather
...
adb shell pm uninstall -k --user 0 com.xiaomi.scanner #Mi Scannercom.miui.screenrecorder
# More and more
